...
namespace NSE.WebApp.MVC.Services
{
    ...
    public class ComprasBffService : Service, IComprasBffService
    {
        ...
        public ComprasBffService(HttpClient httpClient, IOptions<BaseUrlsConfiguration> baseUrlsConfiguration)
        {
            _httpClient = httpClient;
            _baseUrlsConfiguration = baseUrlsConfiguration.Value;

            _httpClient.BaseAddress = new Uri(_baseUrlsConfiguration.ApiComprasBffUrl);
        }
