...
namespace NSE.Bff.Compras.Services
{
    ...
    public class CarrinhoService : Service, ICarrinhoService
    {
        ...
        public CarrinhoService(HttpClient httpClient, IOptions<BaseUrlsConfiguration> baseUrlsConfiguration)
        {
            _baseUrlsConfiguration = baseUrlsConfiguration.Value;
            _httpClient = httpClient;

            _httpClient.BaseAddress = new Uri(_baseUrlsConfiguration.ApiCarrinhoUrl);
        }
